...
public class OpenFile implements Command {
	 ...
	 * @param j - The pane of tabs in the application window
	 */
	...
	/**
	 * Executes the openFile command:
	 * 	Opens a File Browser to load a file
	 * 		If file cannot be loaded, error message displays
	 * 		The load is cancelled
	 * 	A tab with the file's html code is added to the window
	 */
	@Override
	public void execute() {
