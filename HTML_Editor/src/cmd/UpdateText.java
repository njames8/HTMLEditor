...
/**
 * @author nick james
 * Represents a call to update the html file's text
 */
public class UpdateText implements Command {
	 ...
	 * @param j - the collection of tabs
	 */
	...
	/**
	 * Updates the text of the HTML file and updates
	 * the title of the current tab to reflect the need
	 * to be saved
	 */
	@Override
	public void execute() {
